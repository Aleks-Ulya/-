...
Граф может быть ориентированным, где рёбра имеют определённое направление, или неориентированным, с двунаправленными рёбрами. Кроме того, графы бывают весовым, если каждому ребру приписан вес, и невесовым. Примерами графов служат социальные сети, карты дорог, электрические цепи и другие подобные системы.
